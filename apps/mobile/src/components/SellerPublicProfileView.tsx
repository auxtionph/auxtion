  ...
  return (
    ...
    >
      ...
      <View style={{ backgroundColor: '#111827' }}>
        {/* Back */}
        {onBack && (
          <View style={{ paddingTop: embedded ? 8 : 56, paddingHorizontal: 16, paddingBottom: 16 }}>
            <TouchableOpacity onPress={onBack} style={{ flexDirection: 'row', alignItems: 'center', gap: 6, alignSelf: 'flex-start' }}>
        ...
        {/* Avatar + Info */}
        <View style={{ paddingHorizontal: 20, paddingTop: !onBack && !embedded ? 56 : 0, paddingBottom: 20 }}>
              ...
              {row.map(auction => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      if (onAuctionPress) { onAuctionPress(auction.id); return; }
                      router.dismissAll();
