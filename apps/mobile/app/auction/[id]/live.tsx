  ...
  return (
    <View className="flex-1 bg-black">
      ...
      <View className="absolute inset-0 bg-gray-900 items-center justify-center">
        {/* Top half — seller camera placeholder */}
        <View className="absolute top-0 left-0 right-0 bottom-0 bg-gray-900 items-center justify-center">
          <Text className="text-8xl">📺</Text>
          <Text className="text-gray-600 text-sm mt-2">Live Stream</Text>
        </View>

        {/* Bottom half — item photo */}
