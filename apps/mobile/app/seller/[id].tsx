...
export default function ExploreScreen() {
  ...
  const showResults = isFocused && search.trim().length > 0 && (auctions.length > 0 || users.length > 0);
  const showDefault = isFocused && search.trim().length === 0;
  const showResultsEmpty = isFocused && search.trim().length > 0 && !loading && auctions.length === 0 && users.length === 0;
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#0D1117' }}>
      ...
      <View style={{
        ...
        <View style={{
          ...
          <TextInput
            ...
            onChangeText={q => {
              setSearch(q);
              if (q.trim().length > 1) void doSearch(q);
            }}
          ...
          />
          {search.length > 0 && (
            <TouchableOpacity onPress={() => { setSearch(''); setAuctions([]); setUsers([]); }}>
              <View style={{
      ...
      {/* ── Default State (focused, no query) ── */}
      {showDefault && (
      ...
      {showResultsEmpty && (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 32 }}>
          ...
          <Text style={{ color: '#fff', fontWeight: '700', fontSize: 18, marginBottom: 8 }}>No Results</Text>
          <Text style={{ color: '#6B7280', fontSize: 14, textAlign: 'center' }}>
            No shows or sellers found for "{search}"
          </Text>
        </View>
      )}
        ...
        <View style={{ flex: 1 }}>
            ...
            <FlatList
                ...
                return (
                  ...
                  >
                    ...
                    <View style={{ flex: 1, justifyContent: 'center' }}>
                      ...
                      <Text style={{ color: '#fff', fontWeight: '700', fontSize: 14, marginBottom: 4 }} numberOfLines={2}>
                        {item.title}
                      </Text>
              ...
              ListEmptyComponent={
                <View style={{ alignItems: 'center', paddingVertical: 40 }}>
                  <Text style={{ color: '#6B7280', fontSize: 14 }}>No shows found</Text>
                </View>
              }
            />
          )}
          ...
          {activeTab === 'users' && (
            <FlatList
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={{ color: '#6B7280', fontSize: 12, marginTop: 2 }}>
                      {item.totalSales} sales · {item.sellerTier}
                    </Text>
                  </View>
              ...
              ListEmptyComponent={
                <View style={{ alignItems: 'center', paddingVertical: 40 }}>
                  <Text style={{ color: '#6B7280', fontSize: 14 }}>No sellers found</Text>
                </View>
              }
            />
          )}
      ...
      {/* ── Idle State (not focused) ── */}
      {!isFocused && (
        <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: 16 }}>
          <Text style={{ color: '#fff', fontWeight: '700', fontSize: 18, marginBottom: 16 }}>
            Browse Categories
          </Text>
